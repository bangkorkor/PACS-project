...
# Compiler flags
CXXFLAGS=-Wall -std=c++20 -Iinclude -I$(mkBoostInc) 
...
# Source files
SRCS= src/main.cpp src/phys_mod.cpp src/num_mod.cpp src/mixer.cpp src/visualize.cpp src/data_collection.cpp
